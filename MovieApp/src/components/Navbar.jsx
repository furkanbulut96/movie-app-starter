...
const Navbar = () => {
  ...
  // const currentUser = { displayName: "furkan bulut" };
  return (
    <div>
      <nav
      ...
      >
        <div className="flex w-full flex-wrap items-center justify-between px-6">
          <Link classN className="pr-2 text-2xl font-semibold" to="/">
            React Movie App
          </Link>
...
//*Link to ile yollarını verik dinamik hale geldi
//* role = cursor pointer etkisi
//* a ile linkin farkı sayfa reftesh etmesin diye
